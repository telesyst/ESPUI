...
public:
  ...
  fixed_depth_iterator begin_fixed( const iterator_base&,
                                    unsigned int,
...
template< class T, class tree_node_allocator >
void
tree< T, tree_node_allocator >::head_initialise_() {
  ...
  std::allocator_traits< decltype( alloc_ ) >::construct(
    alloc_, head, tree_node_< T >() );
  std::allocator_traits< decltype( alloc_ ) >::construct(
    alloc_, feet, tree_node_< T >() );
...
template< class T, class tree_node_allocator >
void
tree< T, tree_node_allocator >::copy_(
  const tree< T, tree_node_allocator >& other ) {
  clear();
...
template< class T, class tree_node_allocator >
void
tree< T, tree_node_allocator >::clear() {
  if( head )
...
template< class T, class tree_node_allocator >
void
tree< T, tree_node_allocator >::erase_children( const iterator_base& it ) {
...
template< class T, class tree_node_allocator >
void
tree< T, tree_node_allocator >::erase_right_siblings(
...
template< class iter >
iter
tree< T, tree_node_allocator >::erase( iter it ) {
...
template< typename iter >
iter
tree< T, tree_node_allocator >::parent( iter position ) {
  if( position.node == 0 )
...
template< typename iter >
iter
tree< T, tree_node_allocator >::previous_sibling( iter position ) {
...
template< typename iter >
iter
tree< T, tree_node_allocator >::next_sibling( iter position ) {
  assert( position.node != 0 );
  iter ret( position );
...
template< typename iter >
iter
tree< T, tree_node_allocator >::next_at_same_depth( iter position ) const {
...
template< typename iter >
iter
tree< T, tree_node_allocator >::append_child( iter position ) {
...
template< typename iter >
iter
tree< T, tree_node_allocator >::prepend_child( iter position ) {
  assert( position.node != head );
  assert( position.node != feet );
  assert( position.node );
...
template< class iter >
iter
tree< T, tree_node_allocator >::append_child( iter position, const T& x ) {
...
template< class iter >
iter
tree< T, tree_node_allocator >::append_child( iter position, T&& x ) {
  assert( position.node != head );
  assert( position.node != feet );
  assert( position.node );
...
template< class iter >
iter
tree< T, tree_node_allocator >::prepend_child( iter position, const T& x ) {
  assert( position.node != head );
  assert( position.node != feet );
  assert( position.node );
...
template< class iter >
iter
tree< T, tree_node_allocator >::prepend_child( iter position, T&& x ) {
  assert( position.node != head );
  assert( position.node != feet );
  assert( position.node );
...
template< class iter >
iter
tree< T, tree_node_allocator >::append_child( iter position, iter other ) {
  assert( position.node != head );
  assert( position.node != feet );
  assert( position.node );
...
template< class iter >
iter
tree< T, tree_node_allocator >::prepend_child( iter position, iter other ) {
  assert( position.node != head );
  assert( position.node != feet );
  assert( position.node );
...
template< class iter >
iter
tree< T, tree_node_allocator >::append_children( iter             position,
...
template< class iter >
iter
tree< T, tree_node_allocator >::prepend_children( iter             position,
                                                  sibling_iterator from,
                                                  sibling_iterator to ) {
  assert( position.node != head );
  assert( position.node != feet );
...
template< class iter >
iter
tree< T, tree_node_allocator >::insert( iter position, const T& x ) {
  if( position.node == 0 ) {
...
template< class iter >
iter
tree< T, tree_node_allocator >::insert( iter position, T&& x ) {
  if( position.node == 0 ) {
    position.node = feet; // Backward compatibility: when calling insert on a
                          // null node, insert before the feet.
  }
...
template< class T, class tree_node_allocator >
typename tree< T, tree_node_allocator >::sibling_iterator
tree< T, tree_node_allocator >::insert( sibling_iterator position,
                                        const T&         x ) {
  tree_node* tmp =
    std::allocator_traits< decltype( alloc_ ) >::allocate( alloc_, 1, 0 );
  std::allocator_traits< decltype( alloc_ ) >::construct( alloc_, tmp, x );
...
template< class iter >
iter
tree< T, tree_node_allocator >::insert_after( iter position, const T& x ) {
  tree_node* tmp =
    std::allocator_traits< decltype( alloc_ ) >::allocate( alloc_, 1, 0 );
  std::allocator_traits< decltype( alloc_ ) >::construct( alloc_, tmp, x );
  tmp->first_child = 0;
...
template< class iter >
iter
tree< T, tree_node_allocator >::insert_after( iter position, T&& x ) {
  tree_node* tmp =
    std::allocator_traits< decltype( alloc_ ) >::allocate( alloc_, 1, 0 );
  std::allocator_traits< decltype( alloc_ ) >::construct( alloc_, tmp );
  std::swap( tmp->data, x ); // move semantics
...
template< class iter >
iter
tree< T, tree_node_allocator >::insert_subtree( iter                 position,
...
template< class iter >
iter
tree< T, tree_node_allocator >::insert_subtree_after(
...
template< class iter >
iter
tree< T, tree_node_allocator >::replace( iter position, const T& x ) {
...
template< class iter >
iter
tree< T, tree_node_allocator >::replace( iter                 position,
  ...
  std::allocator_traits< decltype( alloc_ ) >::deallocate(
    alloc_, current_to, 1 );
  current_to = tmp;
...
template< typename iter >
iter
tree< T, tree_node_allocator >::flatten( iter position ) {
  if( position.node->first_child == 0 )
    return position;
...
template< typename iter >
iter
tree< T, tree_node_allocator >::reparent( iter             position,
...
template< typename iter >
iter
tree< T, tree_node_allocator >::reparent( iter position, iter from ) {
...
template< typename iter >
iter
tree< T, tree_node_allocator >::wrap( iter position, const T& x ) {
  assert( position.node != 0 );
...
template< typename iter >
iter
tree< T, tree_node_allocator >::wrap( iter from, iter to, const T& x ) {
  assert( from.node != 0 );
...
template< typename iter >
iter
tree< T, tree_node_allocator >::move_after( iter target, iter source ) {
...
template< typename iter >
iter
tree< T, tree_node_allocator >::move_before( iter target, iter source ) {
  tree_node* dst = target.node;
  tree_node* src = source.node;
  assert( dst );
  assert( src );
...
template< typename iter >
iter
tree< T, tree_node_allocator >::move_ontop( iter target, iter source ) {
  tree_node* dst = target.node;
  tree_node* src = source.node;
  assert( dst );
  assert( src );
...
template< typename iter >
iter
tree< T, tree_node_allocator >::move_in( iter loc, tree& other ) {
...
template< typename iter >
iter
tree< T, tree_node_allocator >::move_in_below( iter loc, tree& other ) {
  if( other.head->next_sibling == other.feet )
    return loc; // other tree is empty
...
template< typename iter >
iter
tree< T, tree_node_allocator >::move_in_as_nth_child( iter   loc,
                                                      size_t n,
                                                      tree&  other ) {
  if( other.head->next_sibling == other.feet )
    return loc; // other tree is empty
...
template< class T, class tree_node_allocator >
void
tree< T, tree_node_allocator >::merge( sibling_iterator to1,
...
template< class T, class tree_node_allocator >
void
tree< T, tree_node_allocator >::merge( iterator to,
                                       iterator from,
                                       bool     duplicate_leaves ) {
...
template< class T, class tree_node_allocator >
void
tree< T, tree_node_allocator >::sort( sibling_iterator from,
                                      sibling_iterator to,
                                      bool             deep ) {
  std::less< T > comp;
...
template< typename iter >
bool
tree< T, tree_node_allocator >::equal( const iter& one_,
                                       const iter& two,
...
template< typename iter >
bool
tree< T, tree_node_allocator >::equal_subtree( const iter& one_,
...
template< class T, class tree_node_allocator >
void
tree< T, tree_node_allocator >::subtree( tree&            tmp,
                                         sibling_iterator from,
                                         sibling_iterator to ) const {
  assert( from !=
          to ); // if from==to, the range is empty, hence no tree to return.
...
template< class T, class tree_node_allocator >
size_t
tree< T, tree_node_allocator >::size() const {
  size_t             i  = 0;
...
template< class T, class tree_node_allocator >
size_t
tree< T, tree_node_allocator >::size( const iterator_base& top ) const {
  size_t             i  = 0;
...
template< class T, class tree_node_allocator >
bool
tree< T, tree_node_allocator >::empty() const {
  pre_order_iterator it = begin(), eit = end();
  return ( it == eit );
}
...
template< class T, class tree_node_allocator >
int
tree< T, tree_node_allocator >::depth( const iterator_base& it ) {
...
template< class Predicate >
int
tree< T, tree_node_allocator >::depth( const iterator_base& it, Predicate p ) {
  tree_node* pos = it.node;
  assert( pos != 0 );
  int ret = 0;
  while( pos->parent != 0 ) {
...
template< class Predicate >
int
tree< T, tree_node_allocator >::distance( const iterator_base& top,
                                          const iterator_base& bottom,
                                          Predicate            p ) {
...
template< class T, class tree_node_allocator >
int
tree< T, tree_node_allocator >::max_depth() const {
  int maxd = -1;
...
template< class T, class tree_node_allocator >
unsigned int
tree< T, tree_node_allocator >::number_of_siblings(
...
template< class T, class tree_node_allocator >
void
tree< T, tree_node_allocator >::swap( sibling_iterator it ) {
...
template< class T, class tree_node_allocator >
void
tree< T, tree_node_allocator >::swap( iterator one, iterator two ) {
...
template< class T, class tree_node_allocator >
bool
tree< T, tree_node_allocator >::is_in_subtree(
...
template< class T, class tree_node_allocator >
bool
tree< T, tree_node_allocator >::is_valid( const iterator_base& it ) const {
...
template< class T, class tree_node_allocator >
bool
tree< T, tree_node_allocator >::is_head( const iterator_base& it ) {
  if( it.node->parent == 0 )
    return true;
  return false;
}
...
template< class T, class tree_node_allocator >
unsigned int
tree< T, tree_node_allocator >::index( sibling_iterator it ) const {
  unsigned int ind = 0;
  if( it.node->parent == 0 ) {
...
template< class T, class tree_node_allocator >
void
tree< T, tree_node_allocator >::debug_verify_consistency() const {
  iterator it = begin();
  while( it != end() ) {
...
template< class T, class tree_node_allocator >
T&
tree< T, tree_node_allocator >::iterator_base::operator*() const {
  return node->data;
}
...
template< class T, class tree_node_allocator >
void
tree< T, tree_node_allocator >::iterator_base::skip_children() {
  skip_current_children_ = true;
}

template< class T, class tree_node_allocator >
void
tree< T, tree_node_allocator >::iterator_base::skip_children( bool skip ) {
...
template< class T, class tree_node_allocator >
void
tree< T, tree_node_allocator >::post_order_iterator::descend_all() {
  assert( this->node != 0 );
  while( this->node->first_child )
    this->node = this->node->first_child;
}
...
template< class T, class tree_node_allocator >
void
tree< T, tree_node_allocator >::sibling_iterator::set_parent_() {
  parent_ = 0;
  if( this->node == 0 )
    return;
